...
<div style="padding: 10px 10px 0;">
    ...
    <UmbracoControls:Feedback runat="server" ID="Success" type="success" Text="Digibiz Advanced Media Picker 2.7 successfully installed!" />

    <p>Now that the <strong>Digibiz Advanced Media Picker 2.7</strong> has been installed, you can add the following options. These options have already been saved, so you only need to press the save button if you want to change them.</p>
